...
//    private List<ProductADB> productADBList;
//    private Context context;
//
//    public SjcSubDetailAdapter(List<ProductADB> productADBList, Context context) {
...
//           ((DetailViewHolder) holder).tvDealAmt.setText(productADBList.get(position).getDealAmt()+"");
//           ((DetailViewHolder) holder).tvDealCnt.setText(productADBList.get(position).getDealCnt()+"");
//           ((DetailViewHolder) holder).tvGoodename.setText(productADBList.get(position).getGoodsName());
//           ((DetailViewHolder) holder).tvPrictype.setText(SjcUtil.getPriceTypeString(productADBList.get(position).getPriceType()));
//           ((DetailViewHolder) holder).tvDealPrice.setText(productADBList.get(position).getDealPrice()+"");
//        }
//
//    }
//
